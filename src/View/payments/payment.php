    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Payment</h3>
                <p class="text-subtitle text-muted">This is page Payment Method</p>
            </div>
    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <button class="btn btn-primary block" data-bs-toggle="modal" data-bs-target="#border-less">Add Payment <i
                ...
                <div class="modal fade text-left modal-borderless modal-lg" id="border-less" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                        <form action="" id="formaddpayment" class="form form-horizontal" method="POST"
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 form-group">
                                                <input type="text" name="no_rek" id="no_rek" class="form form-control">
                                            </div>
                                            <div class="col-md-4">
                                                <label>Nama Rekening</label>
                                            </div>
                                            <div class="col-md-8 form-group">
                                                <input type="text" name="nama_rek" id="nama_rek" class="form form-control">
                                            </div>
                                            <div class="col-md-4">
                                                <label>Bank Code</label>
                                            </div>
                                            <div class="col-md-8 form-group">
                                                <input type="text" name="bank_code" id="bank_code" class="form form-control">
                                            </div>
                                            <div class="col-md-4">
                                                <label>Swift Code</label>
                                            </div>
                                            <div class="col-md-8 form-group">
                                                <input type="text" name="swift_code" id="swift_code" class="form form-control">
                                            </div>
                ...
                <button class="btn btn-warning" data-bs-toggle="modal" id="modalupdatepayment">Update Payment <i class="bi bi-person-fill-gear"></i></button>
                <div class="modal fade text-left modal-borderless modal-lg" id="modalEdit" tabindex="-1" role="dialog"
                    aria-labelledby="myModalLabel1" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                        <form action="" id="formupdatepayment" class="form form-horizontal" method="POST"
                            enctype="multipart/form-data">
                            <?= csrf()?>
                            <?= method('PUT')?>
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 form-group">
                                                <input type="text" name="no_rek" id="uno_rek" class="form form-control">
                                            </div>
                                            <div class="col-md-4">
                                                <label>Nama Rekening</label>
                                            </div>
                                            <div class="col-md-8 form-group">
                                                <input type="text" name="nama_rek" id="unama_rek" class="form form-control">
                                            </div>
                                            <div class="col-md-4">
                                                <label>Bank Code</label>
                                            </div>
                                            <div class="col-md-8 form-group">
                                                <input type="text" name="bank_code" id="ubank_code" class="form form-control">
                                            </div>
                                            <div class="col-md-4">
                                                <label>Swift Code</label>
                                            </div>
                                            <div class="col-md-8 form-group">
                                                <input type="text" name="swift_code" id="uswift_code" class="form form-control">
                                            </div>
                                            <div class="col-sm-12 d-flex justify-content-end">
                                                <button type="reset"
                                                    class="btn btn-light-secondary me-1 mb-1">Reset</button>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-primary ml-1" id="updatepayment" data-bs-dismiss="modal">
                                        <i class="bx bx-check d-block d-sm-none"></i>
                                        <span class="d-none d-sm-block">Submit</span>
                                    </button>
                                </div>
                ...
                <button class="btn btn-danger" id="deletepayment">Delete Payment <i class="bi bi-person-x"></i></button>
            </div>
            <div class="card-body">
                <div class="container">
